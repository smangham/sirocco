...
int output_vtk (WindPtr wind, int ndom, int cycle, int property_count, void (*property_pointers[])(WindPtr, FILE *),
                char *property_names[]);
/* vtk_ions.c */
void vtk_temperature_e (WindPtr w, FILE * fptr);
void vtk_ion_c4 (WindPtr w, FILE * fptr);
void vtk_ion_h1 (WindPtr w, FILE * fptr);
/* py_wind_sub.c */
